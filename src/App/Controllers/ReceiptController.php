...
class ReceiptController
{
    ...
    public function uploadView(array $params)
    {
        ...
        echo $this->view->render("receipts/create");
    }
    ...
    public function upload(array $params)
    {
        ...
        $receivedFile = $_FILES['receipt'] ?? null;

        $this->receiptService->validateFile($receivedFile);

        $this->receiptService->upload($receivedFile, $transaction['id']);
