                    ...
                    <td class="p-4 text-sm text-gray-600">
                        <?php foreach ($transaction['receipts'] as $receipt) : ?>
                            <div class="inline-block relative cursor-pointer">
                                <a href="<?php echo escape("/transaction/{$transaction['id']}/receipt/{$receipt['id']}"); ?>" target="_blank">
                                ...
                                <form action="<?php echo escape("/transaction/{$transaction['id']}/receipt/{$receipt['id']}"); ?>" method="POST">
